...
/*** Typedefs necessary for GNU compilers ****/
...
void adi(double **, double **, double **, double **, 
	...
	void amoeba(double **, double *, int, double, doublefunc f, int *);
	...
	double brent(double, double, double, doublefunc f, double, double *);
	...
	void chebft(double, double, double *, int, doublefunc f);
	...
	double dbrent(double, double, double, doublefunc f, doublefunc f,
		double, double *);
	...
	void difeq(int, int, int, int, int, int, int *, int, 
		double **, double **);
	void dlinmin(double *, double *, int, double *, doublefunc f, void (*)());
	...
	void frprmn(double *, int, double, int *, double *, doublefunc f,
		void (*)());
	...
	double golden(double, double, double, doublefunc f, double, double *);
	...
	void ksone(double *, int, doublefunc f, double *, double *);
	...
	void linmin(double *, double *, int, double *, doublefunc f);
	...
	double midexp(doublefunc f, double, double, int);
	double midinf(doublefunc f, double, double, int);
	double midpnt(doublefunc f, double, double, int);
	double midsql(doublefunc f, double, double, int);
	double midsqu(doublefunc f, double, double, int);
	void mmid(double *, double *, int, double, double, int, double *,
		void (*)());
	void mnbrak(double *, double *, double *, double *, 
		double *, double *, doublefunc f);
	...
	void powell(double *, double **, int, double, int *, double *, double (*f)(double*));
	...
	double qgaus(doublefunc f, double, double);
	double qromb(doublefunc f, double, double);
	double qromo(doublefunc f, double, double, doublefunc f);
	void qroot(double *, int, double *, double *, double);
	double qsimp(doublefunc f, double, double);
	double qtrap(doublefunc f, double, double);
	double quad3d(doublefunc f, double, double);
	double ran0(int *);
	double ran1(int *);
int lran1(void) ;
double dran1(void)  ;
double ran2(long *);
	...
	double rtbis(doublefunc f, double, double, double);
	double rtflsp(doublefunc f, double, double, double);
	double rtnewt(void (*)(), double, double, double);
	double rtsafe(void (*)(), double, double, double);
	double rtsec(doublefunc f, double, double, double);
	void rzextr(int, double, double *, double *, double *, int, int);
	void scrsho(doublefunc f);
	...
	double trapzd(doublefunc f, double, double, int);
	...
	int zbrac(doublefunc f, double *, double *);
	void zbrak(doublefunc f, double, double, int, double *, double *, int *);
	double zbrent(doublefunc f, double, double, double);
	...
	double brent(double ax, double bx, double cx, doublefunc f, double tol,
		double *xmin);
	...
	void  chebft(double a, double b, double *c, int n, doublefunc f);
	...
	double golden(double ax, double bx, double cx, doublefunc f, double tol, 
		double *xmin);
	...
	void  kendl2(double **tab, int i, int j, double *tau, double *z,
		double *prob);
	void  ksone(double *data, int n, doublefunc f, double *d,
		double *prob);
	...
	void  lfit(double *x, double *y, double *sig, int ndata, double *a, int ma, 
		...
		voidfunc func);
	void  linmin(double *p, double *xi, int n, double *fret, doublefunc f);
	...
	double midexp(doublefunc f, double aa, double bb, int n);
	double midinf(doublefunc f, double aa, double bb, int n);
	double midpnt(doublefunc f, double a, double b, int n);
	double midsql(doublefunc f, double aa, double bb, int n);
	double midsqu(doublefunc f, double aa, double bb, int n);
	void  mmid(double *y, double *dydx, int nvar, double xs, double htot,
		int nstep, double *yout,
		voidfunc func);
	void  mnbrak(double *ax, double *bx, double *cx, double *fa, double *fb, 
		double *fc, doublefunc f);
	...
	double qgaus(doublefunc f, double a, double b);
	double qromb(doublefunc f, double a, double b);
	void  qroot(double *p, int n, double *b, double *c, double eps);
	double qsimp(doublefunc f, double a, double b);
	double qtrap(doublefunc f, double a, double b);
	double quad3d(doublefunc f, double x1, double x2);
...
double dran1(void)  ;
	...
	double rtbis(doublefunc f, double x1, double x2, double xacc);
	double rtflsp(doublefunc f, double x1, double x2, double xacc);
	double rtnewt(voidfunc func, double x1, double x2,
		double xacc);
	double rtsafe(voidfunc func, double x1, double x2,
		double xacc);
	double rtsec(doublefunc f, double x1, double x2, double xacc);
	...
	double trapzd(doublefunc f, double a, double b, int n);
	...
	int   zbrac(doublefunc f, double *x1, double *x2);
	void  zbrak(doublefunc f, double x1, double x2, int n, double *xb1,
		double *xb2, int *nb);
	double zbrent(doublefunc f, double x1, double x2, double tol);
