...
class voronoicell_base {
	public:
		 ...
		 * \param[in] fp the file handle to write to. */
		virtual void output_neighbors(FILE *fp=stdout) { (void)fp; /* Suppress "unused parameter" warning */ }
		...
		virtual void print_edges_neighbors(int i) { (void)i; /* Suppress "unused parameter" warning */ };
